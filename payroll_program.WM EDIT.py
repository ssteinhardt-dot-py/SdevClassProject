...
# a list to hold all employee info
employeeList = []
...
while prompt_continue():
    ...
    # set up a dictionary for the employee
    employeeDict = {
    ...
    # add the dictionary for the employee to the employeeList
    employeeList.append(employeeDict)
# no more employees, print out all employees in the employeeList
for employee in employeeList:
    display_paycheck(employee['employeeId'], employee['firstName'], employee['lastName'], employee['hoursWorked'], employee['hourlyRate'], employee['grossPay'], employee['totalDeductions'], employee['netPay'])
